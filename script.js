...
const paths = {
 athletic: { title: "Athletic performance", description: "Your goal points toward speed, power, and strength that support your sport. Coaching can balance gym work with practices and competition." },
 strongman: { title: "Strongman training", description: "Your goal points toward event preparation: carries, presses, pulls, grip, and bracing. The events you want to train for help set the direction." },
 powerlifting: { title: "Powerlifting", description: "Your goal points toward squat, bench press, and deadlift development, with technique practice and measurable progression." },
 fitness: { title: "Everyday strength", description: "Your goal points toward foundational strength, movement quality, and work capacity that support everyday life." }
};
...
form.addEventListener("submit", (event) => {
 ...
 context += values.get("experience") === "new"
 ...
 if (equipment === "home") context += "Your equipment list will help identify suitable exercises and whether gym access would support your goal.";
 else if (goal === "strongman" && equipment !== "events") context += "A standard gym can support strength development; discuss access to event equipment for specific practice.";
 else context += "Discuss how your available equipment can support this direction.";
...
form.addEventListener("change", () => { result.hidden = true; summary = ""; });
...
document.querySelector("#copy-summary").addEventListener("click", async () => {
 ...
 try {
  ...
  status.textContent = "Copy is unavailable in this browser. Select and copy the summary above.";
 }
});
...
player.addEventListener("error", () => { videoStatus.textContent = "This video could not be loaded. Try another lift or view training on Instagram."; });
